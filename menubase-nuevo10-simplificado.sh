...
opciones=(
    ...
    "Verificar si un número está en un rango dado:|read -r -p 'Escribir inicio del rango: ' inicio; read -r -p 'Escribir fin del rango: ' fin; for ((i = inicio; i <= fin; i++)); do verificar_rango \$i \$inicio \$fin; done; echo 'Cantidad de números pares: $(( (fin - inicio + 1) / 2 ))'; echo 'Cantidad de números impares: $(( (fin - inicio + 2) / 2 ))'"
